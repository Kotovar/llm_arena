...
export async function renderInApp(ui: ReactNode, path = "/"): Promise<RenderResult & { client: QueryClient }> {
  ...
  const router = createRouter({
    routeTree: rootRoute.addChildren([indexRoute, stub("/runs"), stub("/runs/$runId"), stub("/compare"), stub("/analytics"), stub("/tasks"), stub("/models"), stub("/gallery"), stub("/batch"), stub("/benchmark/compare")]),
